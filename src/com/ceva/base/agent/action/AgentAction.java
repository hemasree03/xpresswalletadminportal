		...
		try {
			...
			requestJSON.put(CevaCommonConstants.MAKER_ID,
			  ...
			  if (responseDTO != null && responseDTO.getErrors().size() == 0) {
				...
				if(actiontype.equalsIgnoreCase("AGENTPASSWORD")){
					PageDirection = "agentpassworddetails";
				}if(actiontype.equalsIgnoreCase("AGENTMOBSTATUS")){
					PageDirection = "agentmobilestatus";
				}if(actiontype.equalsIgnoreCase("AGENTUSSDSTATUS")){
					PageDirection = "agentussdstatus";
				}if(actiontype.equalsIgnoreCase("AGENTPOSSTATUS")){
					PageDirection = "agentposstatus";
				}
...
*/				
	...
	public String AgentPasswordResetAck() {
		 logger.debug("[AgentRegAck][AgentRegModifyAck] Inside AgentRegModifyAck ..");
		 ...
		 try {
		  ...
		  agdao = new AgentDAO();
		  responseDTO = agdao.AgentPasswordResetAck(requestDTO);
		  logger.debug("Response DTO is ["+responseDTO+"]");
		  if (responseDTO != null && responseDTO.getErrors().size() == 0) {
...
public String agentunsettlrequestinfoconfirm() {
	 logger.debug("[AgentReg][AgentReg] Inside AgentReg ..");
...
public String unsettlrequestapproval(){
	...
	try {
		...
		requestJSON.put("remoteip",session.getAttribute("REMOTE_IP"));
		 ...
		 agdao = new AgentDAO();
		responseDTO = agdao.unsettlrequestapproval(requestDTO);
		logger.debug("Response DTO [" + responseDTO + "]");
		if (responseDTO != null && responseDTO.getErrors().size() == 0) {
			responseJSON = (JSONObject) responseDTO.getData().get("LMT_FEE_INFO");
			logger.debug("Response JSON  [" + responseJSON + "]");
...
public String unsettlrequestapprovaldetails(){
	...
	try {
		...
		requestJSON.put("application",application);
		 ...
		 agdao = new AgentDAO();
		responseDTO = agdao.unsettlrequestapprovaldetails(requestDTO);
		logger.debug("Response DTO [" + responseDTO + "]");
		if (responseDTO != null && responseDTO.getErrors().size() == 0) {
			responseJSON = (JSONObject) responseDTO.getData().get("LMT_FEE_INFO");
			logger.debug("Response JSON  [" + responseJSON + "]");
...
public String unsettlrequestapprovalinfo(){
	...
	try {
		...
		requestJSON.put("application",application);
		 ...
		 agdao = new AgentDAO();
		responseDTO = agdao.unsettlrequestapprovalinfo(requestDTO);
		logger.debug("Response DTO [" + responseDTO + "]");
		if (responseDTO != null && responseDTO.getErrors().size() == 0) {
			responseJSON = (JSONObject) responseDTO.getData().get("LMT_FEE_INFO");
			logger.debug("Response JSON  [" + responseJSON + "]");
...
public String unsettlrequestinfoapprovalack() {
	 logger.debug("[AgentRegAck][AgentRegAck] Inside unsettlrequestinfoapprovalack ..");
	 ...
	 try {
	  ...
	  agdao = new AgentDAO();
	  responseDTO = agdao.unsettlrequestinfoapprovalack(requestDTO);
	  logger.debug("Response DTO is ["+responseDTO+"]");
	  if (responseDTO != null && responseDTO.getErrors().size() == 0) {
...
public String viewReconcileinfo(){
	...
	try {
		...
		requestDTO.setRequestJSON(requestJSON);
		agdao = new AgentDAO();
		    System.out.println("in agentdao reconcile info");
...
public String settlemetreportinfo(){
	...
	try {
		...
		System.out.println("In settlemet report info");
...
public String unsettlemetdateinfo(){
	...
	try {
		...
		System.out.println("In un settlemet date report info");
		System.out.println("fullname");
		requestJSON.put("transamt",txnsamt);
		System.out.println("in full name"+txnsamt);
		 
		requestJSON.put("trnsdate",txndatetime);
		requestJSON.put("userid",telephone);
		//requestJSON.put("servicecode",servicecode);
		System.out.println("before setting request");
		requestDTO.setRequestJSON(requestJSON);
		
		
		session = ServletActionContext.getRequest().getSession();
		 System.out.println("ebfore remote ip");
		...
		requestJSON.put("remoteip",session.getAttribute("REMOTE_IP"));
		 ...
		 System.out.println("ebfore calling dao");
			
	 agdao = new AgentDAO();
	responseDTO = agdao.unsettlemetdatewiseinfo(requestDTO);
	logger.debug("Response DTO [" + responseDTO + "]");
	if (responseDTO != null && responseDTO.getErrors().size() == 0) {
		responseJSON = (JSONObject) responseDTO.getData().get("LMT_FEE_INFO");
		logger.debug("Response JSON  [" + responseJSON + "]");
...
public String unsettlementdetailsrequestinfo(){
	...
	try {
		...
		requestJSON.put("requesttype",requesttype);
		 ...
		 agdao = new AgentDAO();
		responseDTO = agdao.unsettlementdetailsrequestinfo(requestDTO);
		logger.debug("Response DTO [" + responseDTO + "]");
		if (responseDTO != null && responseDTO.getErrors().size() == 0) {
			responseJSON = (JSONObject) responseDTO.getData().get("LMT_FEE_INFO");
			logger.debug("Response JSON  [" + responseJSON + "]");
...
public String unsettlementrequestinfoAck() {
	 logger.debug("[AgentRegAck][AgentRegAck] Inside AgentRegAck ..");
	 ...
	 try {
	  ...
	  agdao = new AgentDAO();
	  responseDTO = agdao.unsettlementrequestinfoAck(requestDTO);
	  logger.debug("Response DTO is ["+responseDTO+"]");
	  if (responseDTO != null && responseDTO.getErrors().size() == 0) {
...
public String Agentcustomerview() throws Exception
{
	logger.debug("Inside AgentRegModifySearch..");
	AgentDAO agdao=null;
	ArrayList<String> errors = null;
	try {
		...
		logger.debug("Request DTO [" + requestDTO + "]");
		agdao = new AgentDAO();
		responseDTO= agdao.Agentcustomerview(requestDTO);
		logger.debug("Response DTO [" + responseDTO + "]");
		if (responseDTO != null && responseDTO.getErrors().size() == 0) {
			responseJSON = (JSONObject) responseDTO.getData().get("Files_List");
...
public String AgentMobileStatusAck() {
	 logger.debug("[AgentRegAck][AgentMobileStatusAck] Inside AgentMobileStatusAck ..");
	 ...
	 try {
	  ...
	  logger.debug("[AgentRegAck][AgentMobileStatusAck] Request DTO [" + requestDTO + "]");

	  agdao = new AgentDAO();
	  responseDTO = agdao.AgentMobileStatusAck(requestDTO);
	  logger.debug("Response DTO is ["+responseDTO+"]");
	  if (responseDTO != null && responseDTO.getErrors().size() == 0) {
...
public String AgentUssdStatusAck() {
	 logger.debug("[AgentRegAck][AgentUssdStatusAck] Inside AgentUssdStatusAck ..");
	 ...
	 try {
	  ...
	  logger.debug("[AgentRegAck][AgentUssdStatusAck] Request DTO [" + requestDTO + "]");

	  agdao = new AgentDAO();
	  responseDTO = agdao.AgentUssdStatusAck(requestDTO);
	  logger.debug("Response DTO is ["+responseDTO+"]");
	  if (responseDTO != null && responseDTO.getErrors().size() == 0) {
...
public String AgentPosStatusAck() {
	 logger.debug("[AgentRegAck][AgentPosStatusAck] Inside AgentPosStatusAck ..");
	 ...
	 try {
	  ...
	  logger.debug("[AgentRegAck][AgentPosStatusAck] Request DTO [" + requestDTO + "]");

	  agdao = new AgentDAO();
	  responseDTO = agdao.AgentPosStatusAck(requestDTO);
	  logger.debug("Response DTO is ["+responseDTO+"]");
	  if (responseDTO != null && responseDTO.getErrors().size() == 0) {
