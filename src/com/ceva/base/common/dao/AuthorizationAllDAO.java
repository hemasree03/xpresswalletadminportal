...
public class AuthorizationAllDAO {
	...
	public ResponseDTO CommonAuthListuam(RequestDTO requestDTO) {
		...
		try {
			...
			if (error.equalsIgnoreCase("SUCCESS")) {
				...
				}else if (auth_code.equalsIgnoreCase("ADDNEWGRP")) {
					while (userRS.next()) {
						json.put("REF_NO", userRS.getString(1));
						json.put("group_id", userRS.getString(2));
						json.put("MAKER_ID", userRS.getString(3));
						json.put("MAKER_DATE", userRS.getString(4));
				...
				else if (auth_code.equalsIgnoreCase("MODGRP")) {
					while (userRS.next()) {
						json.put("REF_NO", userRS.getString(1));
						json.put("group_id", userRS.getString(2));
						json.put("MAKER_ID", userRS.getString(3));
				...
				else if (auth_code.equalsIgnoreCase("ACTDCTGRP")) {
					while (userRS.next()) {
						json.put("REF_NO", userRS.getString(1));
						json.put("group_id", userRS.getString(2));
						json.put("MAKER_ID", userRS.getString(3));
	...
	public ResponseDTO CommonAuthList(RequestDTO requestDTO) {
		...
		try {
			...
			requestJSON = requestDTO.getRequestJSON();
			logger.debug("Request JSON hema");
			logger.debug("Request JSON [" + requestJSON + "]");
			resonseJSON = requestJSON;
			...
			if (error.equalsIgnoreCase("SUCCESS")) {
				...
				if (auth_code.equalsIgnoreCase("SERVICEAUTH")) {
				...
				}else if (auth_code.equalsIgnoreCase("AGNTMOBUPDATEAUTH")) {
				...
				}else if (auth_code.equalsIgnoreCase("AGNTUSDSTATUSAUTH")) {
				...
				}else if (auth_code.equalsIgnoreCase("AGNTPOSSTATUSAUTH")) {
				...
				}else if (auth_code.equalsIgnoreCase("LNKACCOUNT")) {
					...
					}else if (auth_code.equalsIgnoreCase("SUPERAGENTMODIFYAUTH")) {
					...
					}else if (auth_code.equalsIgnoreCase("INITIALPRD")) {
						while (userRS.next()) {

							json.put("REF_NO", userRS.getString(1));
							json.put("PRODUCT_CODE", userRS.getString(2));
							json.put("PRODUCT_NAME", userRS.getString(3));
							json.put("MAKER_ID", userRS.getString(4));
							json.put("MAKER_DTTM", userRS.getString(5));
					...
					}else if (auth_code.equalsIgnoreCase("PRDACTAUTH")) {
						while (userRS.next()) {
					...
					}else if (auth_code.equalsIgnoreCase("PRDNEWAUTH")) {
						while (userRS.next()) {
					...
					}else if (auth_code.equalsIgnoreCase("LMTNEWAUTH")) {
						while (userRS.next()) {

							json.put("REF_NO", userRS.getString(1));
							json.put("PRODUCT", userRS.getString(2));
							json.put("LMT_FEE_CODE", userRS.getString(3));
							json.put("LMT_FEE_DESC", userRS.getString(4));
							json.put("MAKER_ID", userRS.getString(5));
							json.put("MAKER_DTTM", userRS.getString(6));
					...
					}else if (auth_code.equalsIgnoreCase("LMTMODAUTH")) {
						while (userRS.next()) {
					...
					}else if (auth_code.equalsIgnoreCase("FEENEWAUTH")) {
						while (userRS.next()) {
					...
					}else if (auth_code.equalsIgnoreCase("FEEMODAUTH")) {
						while (userRS.next()) {
					...
					}else if (auth_code.equalsIgnoreCase("FEEACTAUTH")) {
						while (userRS.next()) {
					...
					}else if (auth_code.equalsIgnoreCase("CATCREAUTH")) {
						while (userRS.next()) {

							json.put("REF_NO", userRS.getString(1));
							json.put("CAT_ID", userRS.getString(2));
							json.put("CAT_NAME", userRS.getString(3));
							json.put("MAKER_ID", userRS.getString(4));
							json.put("MAKER_DTTM", userRS.getString(5));
					...
					}else if (auth_code.equalsIgnoreCase("CATMODIFYAUTH")) {
						while (userRS.next()) {
					...
					}else if (auth_code.equalsIgnoreCase("CATSTATUSAUTH")) {
						while (userRS.next()) {
					...
					}else if (auth_code.equalsIgnoreCase("BILLERCATCREAUTH")) {
						while (userRS.next()) {

							json.put("REF_NO", userRS.getString(1));
							json.put("CATGRP_CODE", userRS.getString(2));
							json.put("CATGRP_NAME", userRS.getString(3));
							json.put("MAKER_ID", userRS.getString(4));
							json.put("MAKER_DTTM", userRS.getString(5));
					...
					}else if (auth_code.equalsIgnoreCase("BILLERCATMODIFYAUTH")) {
						while (userRS.next()) {
					...
					}else if (auth_code.equalsIgnoreCase("BILLERCATSTATUSAUTH")) {
						while (userRS.next()) {
					...
					}else if (auth_code.equalsIgnoreCase("SUBCATCREAUTH")) {
						while (userRS.next()) {
					...
					}else if (auth_code.equalsIgnoreCase("BILLERFEECREAUTH")) {
						while (userRS.next()) {
					...
					}else if (auth_code.equalsIgnoreCase("CASHOUTLNK")) {
					...
					}else if (auth_code.equalsIgnoreCase("CASHOUTMODLNK")) {
	...
	public ResponseDTO CommonAuthConfirmationBefore(RequestDTO requestDTO) {
		...
		try {
			...
			/*else if (auth_code.equalsIgnoreCase("STOREMODAUTH")) {
				...
				responseDTO = authsubDTO.WalletAgentRegistrationAuthData(requestDTO);
			}else if (auth_code.equalsIgnoreCase("AGNTBLOCK")) {
				...
				responseDTO = authsubDTO.WalletAgentLinkedAccountRegAuthData(requestDTO);
			}else if (auth_code.equalsIgnoreCase("AGNTSTATUSAUTH")) {
				responseDTO = authsubDTO.WalletAgentAccountRegAuthData(requestDTO);
			}else if (auth_code.equalsIgnoreCase("TUPWATAUTH")) {
				responseDTO = authsubDTO.WalletAccountRegAuthData(requestDTO);
				...
				responseDTO = authsubDTO.initialProductAuth(requestDTO);
			}else if (auth_code.equalsIgnoreCase("ADDNEWGRP")) {
				responseDTO = authsubDTO
						.viewUserGroup(requestDTO);
			}else if (auth_code.equalsIgnoreCase("MODGRP")) {
				responseDTO = authsubDTO
						.viewUserGroup(requestDTO);
			}else if (auth_code.equalsIgnoreCase("ACTDCTGRP")) {
				...
				responseDTO = authsubDTO.productAuth(requestDTO);
			}else if (auth_code.equalsIgnoreCase("PRDMODAUTH")) {
				responseDTO = authsubDTO.productAuth(requestDTO);
			}else if (auth_code.equalsIgnoreCase("PRDACTAUTH")) {
				responseDTO = authsubDTO.productAuth(requestDTO);
			}else if (auth_code.equalsIgnoreCase("LMTNEWAUTH")) {
				responseDTO = authsubDTO.limitAuth(requestDTO);
			}else if (auth_code.equalsIgnoreCase("LMTMODAUTH")) {
				responseDTO = authsubDTO.limitAuth(requestDTO);
			}else if (auth_code.equalsIgnoreCase("FEENEWAUTH")) {
				responseDTO = authsubDTO.feeAuth(requestDTO);
			}else if (auth_code.equalsIgnoreCase("FEEMODAUTH")) {
				responseDTO = authsubDTO.feeAuth(requestDTO);
			}else if (auth_code.equalsIgnoreCase("FEEACTAUTH")) {
				responseDTO = authsubDTO.feeAuth(requestDTO);
				...
				responseDTO = authsubDTO
						.viewSubCategory(requestDTO);
			}else if (auth_code.equalsIgnoreCase("CASHOUTLNK")) {
				responseDTO = authsubDTO.CashoutAccountRegAuthData(requestDTO);
			}else if (auth_code.equalsIgnoreCase("CASHOUTMODLNK")) {
				responseDTO = authsubDTO.CashoutAccountRegAuthData(requestDTO);
			}else if (auth_code.equalsIgnoreCase("BILLERFEECREAUTH")) {
				responseDTO = authsubDTO.billerFee(requestDTO);
			}
		...
		if(decision.equalsIgnoreCase("A")){
			...
			if(transcode.equalsIgnoreCase("AGNTAUTH")){
				...
				*/
					...
					String msg="Dear "+serviceRS.getString(3)+", you have successfully been created on the Xpress Agent Platform. Please check your registered email address for information on your profile. Let's get started! ";
					String str = "{'recipients': ['"+serviceRS.getString(1)+"'],'sender': 'Xpress','message': '"+msg+"'}";
			...
			if(transcode.equalsIgnoreCase("ACCTPINRESET")){
				query="SELECT ACI.MOBILE_NUMBER,ACM.CUSTOMER_CODE,ACM.FIRST_NAME,WADT.ACCT_NO,ACM.EMAILID FROM AGENT_CUSTOMER_MASTER_TEMP ACM,AGENT_CONTACT_INFO_TEMP ACI,WALLET_ACCT_DATA_TEMP WADT WHERE ACM.ID=ACI.CUST_ID AND WADT.CUST_ID=ACI.CUST_ID  AND ACM.REF_NUM='"+refno+"'";
				...
				if(serviceRS.next())
				{
					pstmt = con.prepareStatement("UPDATE  AGENT_CUSTOMER_MASTER set PIN=? where CUSTOMER_CODE=?");
					...
					String strmsg="<FONT FACE=ARIAL>Dear "+serviceRS.getString(3)+", <BR></FONT>";
					strmsg=strmsg+"<BR> You recently requested for a PIN reset.";
					strmsg=strmsg+"<BR> Your new PIN is "+resp.getString("pin")+". Please change your PIN after logging in to any of the transacting channels.";
					
					pstmt = con.prepareStatement("insert into EMAIL_TBL(EMAIL,SUBJECT,L_MESSAGE,FETCH_FLAG,MSG_DATE,MAKER_ID,TEMPLATE,MESSAGE_TYPE,ATTACHMENT,LONG_DATA,BCC_MAIL,CC_MAIL,NAME) "
							+ "values('"+serviceRS.getString(5)+"','Xpress Agent PIN Reset','"+strmsg+"','N',sysdate,'"+Makerid+"','STATEMENT','EMAIL','N','N','NO','NO','"+transcode+"')");
					...
					String msg="Dear "+serviceRS.getString(3)+", your new PIN is  "+resp.getString("pin")+". Please change your PIN after logging in. ";
					String str = "{'recipients': ['"+serviceRS.getString(1)+"'],'sender': 'Xpress','message': '"+msg+"'}";
