...
public class SuperAgentDaoImpl implements SuperAgentDAO {
	...
	public ResponseDTO save(Map map) {
		...
		String insertprod="{call SUPERAGENTS.insertAgent(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
		...
		try {
			...
			cstmt.setString(1, agent.getCBNAgentId());
			cstmt.setString(2,  agent.getAccountName());
			cstmt.setString(3, agent.getSuperagentname());
			cstmt.setString(4, password);
			cstmt.setString(5, passhash);
			cstmt.setString(6, agent.getBvn());
			cstmt.setString(7, agent.getBankname());
			cstmt.setString(8, agent.getProduct());
			cstmt.setString(9, agent.getProdesc());
			cstmt.setString(10, agent.getEmail());
			cstmt.setString(11, agent.getMobile());
			cstmt.setString(12, "");
			cstmt.setString(13, agent.getAddressLine());
			cstmt.setString(14, agent.getCity());
			cstmt.setString(15, agent.getLocalGovernment());
			cstmt.setString(16, agent.getState());
			cstmt.setString(17, agent.getCountry());
			cstmt.setString(18, agent.getStreetname());
			cstmt.setString(19,  agent.getWardname());
			cstmt.setString(20, agent.getDob());
			cstmt.setString(21, agent.getGender());
			
			cstmt.setString(22, agent.getIdcardtype());
			cstmt.setString(23, agent.getIdcardnumber());
			cstmt.setString(24, agent.getNationality());
			cstmt.setString(25, map.get(CevaCommonConstants.IP)+"");
			cstmt.setString(26, map.get(CevaCommonConstants.MAKER_ID)+"");
