	...
	public String CommonAuthCnf() {
		...
		try {
			...
			if (AUTH_CODE.equalsIgnoreCase("USERAUTH")) {
				...
				userInfoPage = "LinkedAccountRegNewAuthAck";
				...
				userInfoPage = "IntialProductAck";
		    }else if (AUTH_CODE.equalsIgnoreCase("ADDNEWGRP")) {
				userInfoPage = "GroupStatusAuthrization"; 
				...
				userInfoPage = "CategoryAuthrization";
				...
				userInfoPage = "BillerCategoryAuthrization";
