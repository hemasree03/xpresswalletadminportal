...
public class SuperAgentAction extends ActionSupport implements ModelDriven<Agent>{
	...
	public String getSuperprodesc() {
		return superprodesc;
	}
	public void setSuperprodesc(String superprodesc) {
		this.superprodesc = superprodesc;
	}
	...
	public String SuperagentModifyDetails() {

		logger.debug("Inside modifydetails... ");
		LimitDao lmtDAO = null;
		ArrayList<String> errors = null;
		...
		try {
			...
			logger.debug("Request DTO [" + requestDTO + "]");
			lmtDAO = new LimitDao();
			responseDTO = lmtDAO.SuperagentModifyDetails(requestDTO);
			logger.debug("Response DTO [" + responseDTO + "]");
	...
	public String SuperproductModify() {
		...
		try {
			...
			requestDTO = new RequestDTO();
			requestJSON.put("accNumbers", accNumbers);
			requestJSON.put("product", superproduct);
			requestJSON.put("prodesc", superprodesc);
			requestJSON.put(CevaCommonConstants.IP, ServletActionContext.getRequest().getRemoteAddr());
			requestJSON.put(CevaCommonConstants.MAKER_ID, ServletActionContext.getRequest().getSession().getAttribute(CevaCommonConstants.MAKER_ID));
			...
			logger.debug("Request DTO [" + requestDTO + "]");
			lmtDAO = new LimitDao();
			responseDTO = lmtDAO.SuperproductModify(requestDTO);
			logger.debug("Response DTO [" + responseDTO + "]");
