...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/rightclick_script111.js"></script>
...
body{
 ...
 background-color: #99356b; 
    background-image: -moz-linear-gradient(top, #b03d7b, #ffab4c);
    background-image: -ms-linear-gradient(top, #b03d7b, #ffab4c);
    background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#b03d7b), to(#ffab4c));
    background-image: -webkit-linear-gradient(top, #ffab4c, #ffab4c);
    background-image: -o-linear-gradient(top, #b03d7b, #ffab4c);
    background-image: linear-gradient(top, #b03d7b, #ffab4c);
    background-repeat: repeat-x;
    filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#b03d7b', endColorstr='#ffab4c', GradientType=0);
    border-color: #ffab4c #ffab4c #3e152b;
