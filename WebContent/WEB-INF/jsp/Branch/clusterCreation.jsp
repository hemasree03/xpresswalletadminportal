...
var branchdata="adminType|text#adminName|text#stated|text#localGovernment|text#"; //branchaccno|text#
...
function validateData(myval,myfinalobj,val)
{
	...
	var stated = myval.stated;
	var localGovernment = myval.localGovernment;
			...
			$.each(myfinalobj, function(index,jsonObject)
					{ 
							...
							var tabstated  = jsonObject.stated;
							var tablocalGovernment =jsonObect.localGovernment;
...
function buildfeetable(jsonArray)
{
	...
	$.each(jsonArray, function(index,jsonObject){
			...
			//my changes 
			htmlString = htmlString + "<td id='stated' name=stated >" + jsonObject.stated + "</td>";
			htmlString = htmlString + "<td id='localGovernment' name=localGovernment >" + jsonObject.localGovernment+ "</td>";
...
function upatedata(myval)
{
	...
	$('#stated').val(myval.stated);
	$("#localGovernment").val(myval.localGovernment);
	dataupdateval=myval; 
			...
			<div class="box span12">
							...
							<div class="box-content">
								<fieldset>
									...
									<table width="950" border="0" cellpadding="5" cellspacing="1"
										...
										<tr class="odd">
											<td width="20%"><label for="Channel"><strong>Branch
														Id<font color="red">*</font>
												</strong></label></td>
											<td width="30%"><input name="adminType" id="adminType"
												type="text" class="field" /></td>
											<td width="20%"><label for="Services"><strong>Branch
														Name <font color="red">*</font>
												</strong></label></td>
											<td width="30%"><input name="adminName" id="adminName"
												type="text" class="field" /></td>

										</tr>
                                         <tr class="odd">

                                                    <td><label for="State"><strong>State<font
																color="red">*</font></strong></label></td>
													<td><select id="stated" name="stated"
														class="chosen-select-width" style="width: 220px;">
															<option value="">Select</option>
													</select> <input name="state" type="hidden" class="field" id="state" />
													</td>
													<td><label for="Local Government"><strong>Local
																Government<font color="red">*</font>
														</strong></label></td>
													<td><select id="localGovernment"
														name="localGovernment" class="chosen-select-width"
														style="width: 220px;">
															<option value="">Select</option>
													</select></td>
												</tr>
					...
					<table width="100%"
						...
						<thead>
							<tr>
								...
								<th width="20%">Local Government</th>
				...
				<form name="form2" id="form2" method="post" action="">
					<div class="form-actions" id="submitdata" style="display: none">
						...
						<input type="button" id="non-printable" class="btn btn-success"
							onclick="redirectAct();" value="Back" /> <input type="button"
							id="non-printable" class="btn btn-success" onclick="subitReq();"
							value="Submit" />
					</div>
