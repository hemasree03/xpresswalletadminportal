...
$(document).ready(function() {
	...
	$('#btn-submit').live('click', function () {
		...
		var url="${pageContext.request.contextPath}/<%=appName %>/updatebranchstatus.action"; 
		$("#form1")[0].action=url;
		$("#form1").submit();
...
<form name="form1" id="form1" method="post" >
      ...
      <div id="content" class="span10"> 
	    <div> 
			...
			<li><a href="clusterCreation.action">Status Update Confirmation</a> </li>
 			</ul>
		</div>  
	 	<table height="3">
				 <tr>
	...
	<div class="row-fluid sortable">
		...
		<div class="box-content">
								...
								<td width="25%"><label for="Limit Code"><strong>Branch Id</strong></label></td>
								 <td width="25%">${limitCode}
								 <input name="limitCode" id="limitCode" type="hidden"  required="true" class="field" value="${limitCode}" />
								 </td>
								
								 <td width="25%"><label for="Limit Description"><strong>Branch Name<font color="red">*</font></strong></label></td>
							<td width="25%">${limitDesc}
							<input name="limitDesc" id="limitDesc" type="hidden"  required="true" class="field" value="${limitDesc}" /><span id="bin_err1" class="errmsg"></span></td>
							
							</tr>
							<tr class="even">
								<td width="25%"><label for="Limit Code"><strong>State</strong></label></td>
								<td width="25%">${state}
								<input name="state" id="state" type="hidden"  required="true" class="field" value="${state}" />
								</td>
								 <td width="25%"><label for="Limit Description"><strong>Local Government</strong></label></td>
								 <td width="25%">${localGovernment}
								 <s:property value='#respData.limitcodedetails.LGA' /> 
								 <input name="localGovernment" id="localGovernment" type="hidden"  required="true" class="field" value="${localGovernment}" />
								 </td>
							</tr>
							<tr class="even">
