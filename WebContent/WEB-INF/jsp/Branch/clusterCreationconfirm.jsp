...
function buildbranchtable(jsonArray)
{
	...
	$.each(jsonArray, function(index,jsonObject){
			...
			htmlString = htmlString + "<td id='tabchannel' name=tabchannel >" + jsonObject.stated + "</td>";
			htmlString = htmlString + "<td id='tabservices' name=tabservices >" + jsonObject.localGovernment + "</td>";
			...
			<div class="row-fluid sortable">
				...
				<div class="box span12">
					...
					<div class="box-header well" data-original-title>
						Branch Creation Configuration Confirm
						<div class="box-icon">
					...
					<div class="form-actions" id="submitdata">
						...
						<input type="hidden" id="finaljsonarray" name="finaljsonarray"
							value='${responseJSON.FINAL_JSON}'> <input type="button"
							id="non-printable" class="btn btn-success"
							onclick="redirectAct();" value="Home" /> <input type="button"
							id="non-printable" class="btn btn-success"
							onclick="confirmAct();" value="Confirm" />
