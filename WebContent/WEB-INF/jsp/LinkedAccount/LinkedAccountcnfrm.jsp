...
$(function() {  
	...
	$('#btn-submit').on('click', function(){
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/linkedaccountack.action'; 
		$("#form1").submit();
			...
			<div>
				<ul class="breadcrumb">
					<li><a href="home.action">Home</a> <span class="divider">
							&gt;&gt; </span></li>
					<li><a href="#">Account Link  Confirmation</a></li>
				</ul>
			</div>
						...
						<div class="box-content">
							<fieldset>
								<table width="950" border="0" cellpadding="5" cellspacing="1"
									...
									<tr class="even">
										<td><label for="Street"><strong>Street
													Name 
											</strong></label></td>
										<td><s:property value='area' /> <input type="hidden"
									...
									<tr class="even">
										...
										<td><s:property value='state' /> <input name="state"
									...
									<tr class="even" id="superadmin" name="superadmin">
										...
										<td><label for="wardname"><strong>Ward
													Name
											</strong></label></td>

										<td><s:property value='wardname' /> <input type="hidden"
