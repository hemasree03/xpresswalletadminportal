	...
	$('#btn-submit').on('click', function(){
		$("#form1").validate(acctRules);
		 if($("#form1").valid() ) {  
			 ...
			 $("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/linkedaccountcnfrm.action'; 
				$("#form1").submit();
			...
			<div>
				<ul class="breadcrumb">
					<li><a href="home.action">Home</a> <span class="divider">
							&gt;&gt; </span></li>
					<li><a href="#">Account Link Details</a></li>
				</ul>
			</div>
                       ...
                       <tr class="even">
								...
								<td  width="25%">${responseJSON.nationality} <input type="hidden" name="nationality"  id="nationality"   value="${responseJSON.nationality}"   />  </td>
									 ...
									 <tr class="even">
											...
											<td  width="25%" >${responseJSON.lga}<input type="hidden" value='${responseJSON.lga}'  name="lga" id="lga"  /> 
											</td>
										</tr>
						...
						<div class="row-fluid sortable">
 						 ...
 						 <td width="25%"><strong>Bank Name<font color="red">*</font></strong></td>
							...
							<td width="25%"><strong>Bank Account Number<font color="red">*</font></strong></td>
						      <td width="25%"><input type="text" name="bankaccnumber" id="bankaccnumber" class="field"   maxlength="10"  required='true'  />
						    ...
						    <div class="errorm" id="errorm"></div>
										    ...
										    <tr class="odd">
												...
												<td><label for="Local Government"><strong>Account Name<font color="red">*</font></strong></label></td>
												<td>
												<input  type="text" class="field" id="accname" name="accname" /></td>
												<td></td>
												<td></td>
											</tr>
