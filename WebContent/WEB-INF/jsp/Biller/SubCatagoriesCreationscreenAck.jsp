			    ...
			    <div> 
					<ul class="breadcrumb">
					  ...
					  <li> <a href="#">Biller Mapping</a> <span class="divider"> &gt;&gt; </span></li>
 					  <li><a href="#">Sub Category Creation Acknowledge </a></li>
					</ul>
				</div>  
		<div class="row-fluid sortable">
			...
			<div class="box span12">
				...
				<div class="box-header well" data-original-title>
						<i class="icon-edit"></i>Sub Category Creation Acknowledge
					<div class="box-icon">
		...
		<div class="box-content">
		 <fieldset> 
				<table width="950" border="0" cellpadding="5" cellspacing="1" 
						 ...
						 <tr>
							<td></td>
							<td >'${groupType }' Category Creation Done Successfully.Pending for Authorization. </td>
							<td ></td>	
						</tr>
				</table>  
		</fieldset> 
