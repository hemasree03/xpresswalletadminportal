	...
	function constructStringSubSub(parentSubSId,parentId) {
		...
		$(document).ready(function(){
			...
			$('#btn-submit').live('click',function() { 
				...
				$("#form1")[0].action="<%=request.getContextPath()%>/<%=appName %>/billercatsaveGroupDetails.action";
				$("#form1").submit();				
			});
	...
	<form name="form1" id="form1" method="post">
			    ...
			    <div> 
					<ul class="breadcrumb">
					  ...
					  <li> <a href="#">Biller Category Management</a> <span class="divider"> &gt;&gt; </span></li>
 					  <li><a href="#">Biller Category Creation Confirmation </a></li>
					</ul>
				</div>  
		<div class="row-fluid sortable">
			...
			<div class="box span12">
				...
				<div class="box-header well" data-original-title>
						<i class="icon-edit"></i>Biller Category Creation Confirmation
					<div class="box-icon">
		...
		<div class="box-content">
		 <fieldset> 
				<table width="950" border="0" cellpadding="5" cellspacing="1" 
						...
						<tr>
							<td width="25%"><strong><label for="Group Type"><strong>BillerCategory Group</strong></label></strong></td>
							<td width="25%" >${groupType} <input name="groupType" type="hidden" class="field" id="groupType"  value="${groupType}"  /></td>	
							<td width="25%"><strong><label for="User Level"><strong>BillerCategory Description</strong></label></strong></td>
		...
		<div class="row-fluid sortable">
			...
			<div class="box span12">
				...
				<div class="box-header well" data-original-title>
						<i class="icon-edit"></i>Assigned To Categories
					<div class="box-icon">
						<a href="#" class="btn btn-setting btn-round"><i
							class="icon-cog"></i></a> <a href="#"
							class="btn btn-minimize btn-round"><i
