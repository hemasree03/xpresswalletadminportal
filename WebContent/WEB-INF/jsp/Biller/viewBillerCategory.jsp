...
$(document).ready(function(){
	...
	if(toDisp == 'View') {
		...
		actionLink = "modifyBillerCategoryConfirm.action";
				...
				<table width="950" border="0" cellpadding="5" cellspacing="1" 
					class="table table-striped table-bordered bootstrap-datatable "> 
						...
						<tr >
							...
							<td width="25%"><label for="Region"><strong>BillerCategory Group </strong></label></td>
							<td width="25%">
							 ${responseJSON.groupType}</td>
							 <td  width="25%"><label for="Region"><strong>BillerCategory Description </strong></label></td>
							<td  width="25%" >
