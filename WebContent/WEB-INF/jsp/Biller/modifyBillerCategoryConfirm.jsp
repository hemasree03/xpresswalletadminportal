	...
	function constructStringSubSub(parentSubSId,parentId) {
		...
		$(document).ready(function(){
			...
			$('#btn-submit').live('click',function() { 
				...
				$("#form1")[0].action="<%=request.getContextPath()%>/<%=appName %>/modifybillercatsaveGroupDetails.action";
				$("#form1").submit();				
			});
			...
			<div id="content" class="span10">
			    ...
			    <div> 
					<ul class="breadcrumb">
					  ...
					  <li> <a href="#">Biller Category Management</a> <span class="divider"> &gt;&gt; </span></li>
 					  <li><a href="#">Category Modify Confirmation </a></li>
					</ul>
				</div>  
		<div class="row-fluid sortable">
			...
			<div class="box span12">
				...
				<div class="box-header well" data-original-title>
						<i class="icon-edit"></i>Category Creation Confirmation
					<div class="box-icon">
		...
		<div class="box-content">
		 <fieldset> 
				<table width="950" border="0" cellpadding="5" cellspacing="1" 
						...
						<tr>
							<td width="15%"><strong><label for="Group Type"><strong>BillerCategory Group</strong></label></strong></td>
							<td width="35%" >${groupType} <input name="groupType" type="hidden" class="field" id="groupType"  value="${groupType}"  /></td>	
							<td width="15%"><strong><label for="User Level"><strong>BillerCategory Description</strong></label></strong></td>
							<td width="35%" >${catids} <input name="catids" type="hidden" class="field" id="catids"  value="${catids}"  /></td>	
							<td></td>
							<td></td>
						...
						<%-- 	<td width="25%"><label for="Region"><strong>Status </strong></label></td>
							<td width="25%">
							 ${status}<input type="hidden" name="status" id="status" value="${status}"/></td>
							 <td  width="25%"></td>
							<td  width="25%" ></td> --%>
