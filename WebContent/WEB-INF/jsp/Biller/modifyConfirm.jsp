	...
	function constructStringSubSub(parentSubSId,parentId) {
		...
		$(document).ready(function(){
			...
			$('#btn-submit').live('click',function() { 
				...
				$("#form1")[0].action="<%=request.getContextPath()%>/<%=appName %>/modifyChangeAck.action";
				$("#form1").submit();				
			});
			    ...
			    <div> 
					<ul class="breadcrumb">
					  ...
					  <li> <a href="#">Biller Mapping</a> <span class="divider"> &gt;&gt; </span></li>
 					  <li><a href="#">Category Creation Confirmation </a></li>
					</ul>
				</div>  
		...
		<div class="box-content">
		 <fieldset> 
				<table width="950" border="0" cellpadding="5" cellspacing="1" 
						...
						<tr>
							<td width="15%"><strong><label for="Group Type"><strong>Category Name</strong></label></strong></td>
							<td width="35%" >${groupType} <input name="groupType" type="hidden" class="field" id="groupType"  value="${groupType}"  /></td>	
							<td width="15%"><strong><label for="User Level"><strong>Category Id</strong></label></strong></td>
						...
						<tr>
							<td width="15%"><strong><label for="Group Type"><strong>Status</strong></label></strong></td>
							<td width="35%" >${status} <input name="status" type="hidden" class="field" id="status"  value="${status}"  /></td>	
							<td width="15%"></td>
							<td width="35%" ></td>	
							<td></td>
							<td></td>
