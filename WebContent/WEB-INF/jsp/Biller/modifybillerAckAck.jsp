			    ...
			    <div> 
					<ul class="breadcrumb">
					  ...
					  <li> <a href="#">Biller Category Management</a> <span class="divider"> &gt;&gt; </span></li>
 					  <li><a href="#">Category Modify Acknowledge </a></li>
					</ul>
				</div>  
		<div class="row-fluid sortable">
			...
			<div class="box span12">
				...
				<div class="box-header well" data-original-title>
						<i class="icon-edit"></i>Category Modify Acknowledge
					<div class="box-icon">
		...
		<div class="box-content">
		 <fieldset> 
				<table width="950" border="0" cellpadding="5" cellspacing="1" 
						 ...
						 <tr>
							<td></td>
							<td >'${groupType }' Category Data Updated  Successfully.Pending for Authorization. </td>
							<td ></td>	
						</tr>
				</table>  
		</fieldset> 
