...
$(document).ready(function() {
	...
	$('#groupType1').live('change',function(){
		
		$('#catids').val(($('#groupType1').val()).split("-")[1]);
		$('#catid').text(($('#groupType1').val()).split("-")[1]);
		$('#groupType').val(($('#groupType1').val()).split("-")[0]);
	 ...
	 $.getJSON('Catadetails.action', '',function(data) {
			...
			$.each(json, function(i, v) {
				...
				$('#groupType1').append(options);
				$('#groupType1').trigger("liszt:updated");
			});
		});
	...
	$('#btn-submit').live('click',function() { 
		...
		var url="<%=ctxstr%>/<%=appName %>/userCatCreationNewDetails.action";
		$("#form1")[0].action=url;
		$("#form1").submit();  
				...
				<div class="box-content">
					<fieldset> 
						<table width="950" border="0" cellpadding="5" cellspacing="1" 
								...
								<tr>
									<td width="15%"><strong><label for="Group Type"><strong>Category Name</strong><font color="red">*</font></label></strong></td>
									<td width="35%" >
											<select id="groupType1" name="groupType1"  required='true' data-placeholder="Choose member type..." 
									...
									<td width="25%" ><div id="catid"></div></td> 
