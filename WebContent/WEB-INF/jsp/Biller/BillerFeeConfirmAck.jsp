			   ...
			   <div>
				<ul class="breadcrumb">
					<li><a href="home.action">Home</a> <span class="divider">
							&gt;&gt; </span></li>
					<li><a href="#">Biller Fee Creation Acknowledge</a></li>
				</ul>
			</div>
		...
		<div class="row-fluid sortable">
			...
			<div class="box span12">
				...
				<div class="box-header well" data-original-title>
						<i class="icon-edit"></i>Biller Fee Creation  Acknowledge
					<div class="box-icon">
		...
		<div class="box-content">
		 <fieldset> 
				<table width="950" border="0" cellpadding="5" cellspacing="1" 
						 ...
						 <tr>
							<td></td>
							<td >'${catids }' Biller Fee Creation Successfully.Pending for Authorization. </td>
							<td ></td>	
						</tr>
				</table>  
		</fieldset> 
