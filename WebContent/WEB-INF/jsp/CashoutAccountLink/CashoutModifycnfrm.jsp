...
$(function() {  
	...
	$('#btn-submit').on('click', function(){
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/cashoutmodifyack.action'; 
		$("#form1").submit();
			...
			<div>
				<ul class="breadcrumb">
					<li><a href="home.action">Home</a> <span class="divider">
							&gt;&gt; </span></li>
					<li><a href="#">Cashout Account Link  Confirmation</a></li>
				</ul>
			</div>
										...
										<fieldset>
											<table width="950" border="0" cellpadding="5" cellspacing="1"
												...
												<tr class="even">
													...
													<td width="25%"><s:property value='accountno' /> 
													<input type="hidden" name="accountno"  id="accountno" value="	<s:property value='accountno'/>" /></td>
												</tr>
												<tr class="even">
													<td width="25%"><label for="Account Name"><strong>Account Name </strong></label></td>
													<td width="25%"><s:property value='bankcustname' /> <input type="hidden" name="bankcustname" id="bankcustname" value="<s:property value='bankcustname'/>" /></td>
