			...
			<ul class="breadcrumb">
			 <li><a href="home.action">Home</a> <span class="divider">
					...
					<li><a href="superagent.acton?pid=1">Super Agent Management</a> <span class="divider">
							&gt;&gt; </span></li>
					<li><a href="#">Super Agent Create Acknowledgement</a></li>
			</ul>
		</div>
		...
		<div class="row-fluid sortable"><!--/span--> 
					<div class="box span12"> 
						 <div class="box-header well" data-original-title>
								<i class="icon-edit"></i>Super Agent Registration Acknowledgement
							<div class="box-icon">
						...
						<div class="box-content" id="primaryDetails">  
						  <fieldset> 
								<table width="950" border="0" cellpadding="5" cellspacing="1" 
									...
									<tr class="even">
										<td > <strong>Super Agent  Successfully Created, Authorization Pending </strong></td>
									</tr>
								</table>
							 </fieldset> 
							</div>
