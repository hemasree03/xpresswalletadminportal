	...
	<div id="content" class="span10">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li> <a href="#">Super Agent Modify</a> </li>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						Super Agent Modify Acknowledgment
					</div>
					...
					<div id="primaryDetails" class="box-content">
						...
						<div><strong>Super Agent Modified successfully,Authorization Pending</strong></div>	
			...
			<div class="form-actions" align="left"> 
				...
				<input type="button" id="non-printable" class="btn btn-info" onclick="redirectHome();" value="Next" />
			</div>  
