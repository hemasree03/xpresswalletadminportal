			...
			<ul class="breadcrumb">
			 <li><a href="home.action">Home</a> <span class="divider">
					...
					<li><a href="superagent.acton?pid=1">Super Agent Management</a> <span class="divider">
							&gt;&gt; </span></li>
					<li><a href="#">Super Agent Status Acknowledgement</a></li>
			</ul>
		</div>
		...
		<div class="row-fluid sortable">
			<div class="box span12">
				<div class="box-header well" data-original-title>
						<i class="icon-edit"></i>Super Agent Status Acknowledgment
					<div class="box-icon">
				...
				<div class="box-content" id="acktbl">
					<span>Super Agent Status Updated Successfully, Authorization Pending</span>
				</div>
				</div>
			</div>
