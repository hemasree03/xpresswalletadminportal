							...
							<fieldset>
								...
								<td ><label for="Date Of Birth"><strong>Date Of Birth</label></td>
									...
									<tr class="even">
										...
										<td>${mailid}
										<input type="hidden" name="agent.email" id="email" value='${mailid}'></td>
										   </tr>
									<tr class="odd">
										
										<td ><strong><label for="Mobile"><strong>Mobile</strong></label></strong></td>
										<td>${mobile}
										<input type="hidden" name="agent.mobile"  id="mobile"  value='${mobile}'  ></td>
										 ...
										 <td width="25%"><label for="Nationality"><strong>BVN</strong></label></td>
										   ...
										   <tr class="even">
										       ...
										       <td width="25%">${prodesc}
										       <input type="hidden"  name="agent.product" id="product"  value="${product}" />
												<input type="hidden"  name="agent.prodesc" id="prodesc"  value="${prodesc}" />
										       </td>  
											</tr> 
