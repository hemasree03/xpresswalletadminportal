...
var acctRules = {
		   rules : {
			   fullname: { required : true,regex: /^[a-zA-Z0-9 ]+$/},
			   lastname: { required : true,regex: /^[a-zA-Z0-9 ]+$/},
			   ...
			   bvn:{ required : true, regex: /^[0-9]+$/},
			   productcode1: { required : true},
		   ...
		   messages : {
			   ...
			   fullname : { 
			   		...
			   		regex : "First Name, can not allow special characters."
				},
				lastname: { 
							   		required : "Please enter Last Name.",
							   		regex : "Last Name, can not allow special characters."
								},
				...
				bvn: { 
							   		required : "Please Select BVN Number.",
							   		regex : "BVN number allows numbers only"
								},
				productcode1: { 
