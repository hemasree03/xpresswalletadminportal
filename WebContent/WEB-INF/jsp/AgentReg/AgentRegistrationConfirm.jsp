...
$(function() {  
	...
	$('#btn-submit').on('click', function(){
		...
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/wagentregistrationack.action'; 
		$("#form1").submit();
				...
				<div class="box-content">
					...
					<table width="950" border="0" cellpadding="5" cellspacing="1" 
						...
						<tr class="even">
						   ...
						   <td ><label for="From Date"><strong>BVN</strong></label></td>
							<td >
							  ${responseJSON.bvn}
 						...
 						<tr class="even">
							...
							<td ><label for="From Date"><strong>Super Agent</strong></label></td>
							<td >
							  ${responseJSON.superagn}
					    
								<input type="hidden"  name="superagn" id="superagn" value="${responseJSON.superagn}" /> 
							</td>
						   <td></td>
					       <td ></td> 
 						...
 						<tr class="even">
							...
							<td ><label for="From Date"><strong>Product</strong></label></td>
							<td >
							  ${responseJSON.productcode}
					    
								<input type="hidden"  name="productcode" id="productcode" value="${responseJSON.productcode}" /> 
							</td>
						   <td ><label for="From Date"><strong>Product Description</strong></label></td>
							<td >
							  ${responseJSON.productdesc}
					    
								<input type="hidden"  name="productdesc" id="productdesc" value="${responseJSON.productdesc}" /> 
							</td> 
 						...
 						<tr class="even">
							...
							<td >
							  ${responseJSON.staffcode}
								...
								<input type="hidden"  name="staffcode" id="staffcode" value="${responseJSON.staffcode}" /> 
							</td>
						   <td ></td>
							<td ></td> 
									...
									<fieldset>
										<table width="950" border="0" cellpadding="5" cellspacing="1"
										   ...
										   <tr class="even">
												 ...
												 <td width="25%"><label for="Address Line 1"><strong>Account Name</strong></label></td>
												<td width="25%">${responseJSON.accname}
												</td>
