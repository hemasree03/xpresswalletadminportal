						...
						<table width="950" border="0" cellpadding="5" cellspacing="1"  class="table table-striped table-bordered bootstrap-datatable ">
							...
							<tr class="even" id="limitperday" >
									...
									<td id="tokenlimit4" style="display:none">${agent}<input name="agent"  type="hidden" id="agent" class="field" value="${agent}"></td> --%>
									 <td><label for="ToKenLimit"><strong>BillerCategory Group
										</strong></label></td>
									 <td>${BillerCategory}
									 <input name="BillerCategory"  type="hidden" id="BillerCategory" class="field" value="${BillerCategory}">
									 </td>
									
								</tr>
								
								<tr>
								<td id="tokenlimit3" ><strong>Super Agent</strong></td>
									<td id="tokenlimit4" >${agent}
									<input name="agent"  type="hidden" id="agent" class="field" value="${agent}">
									</td>
