		   ...
		   messages : {
			  ...
			  perdaylimit : {
			   ...
			   application : { 
				...
				BillerCategory : { 
				     required : "Please Select BillerCategory Group"
				},
				 feename: { 
	...
	$.validator.addMethod("regex", function(value, element, regexpr) {          
		...
		function addrow()
		{
				...
				console.log("Addrow >>>> ");
					...
					var perdaylimit = $("#perdaylimit").val();
					...
					if(perdaylimit=="") { 
						 $("#errormsg").html("<font colour='red'>Please Enter Product Per Day Limit Amount</font>");
							return false;
					}
					
					if(parseInt(finalobj.cperdaylmt) > parseInt(perdaylimit)){
						$("#errormsg").html("<font colour='red'>Channel Per Day limit should not be more than Pruduct Per Day limit</font>");
						return false;
		...
		function checkEqual(val)
		{
			...
			if(parseInt(newupdateddataobj.cperdaylmt) > parseInt(perdaylimit)){
				$("#errormsg").html("<font colour='red'>Channel Per Day limit should not be more than Pruduct Per Day limit</font>");
				return false;
							...
							<table width="950" border="0" cellpadding="5" cellspacing="1"
								...
								<tr class="even" id="limitperday" >
									...
									<select name="agent" id="agent" Class="chosen-select">
									 ...
									 <td><label for="ToKenLimit"><strong>BillerCategory Group<!-- <font color="red">*</font> -->
										</strong></label></td>
									 <td>
									 <s:select cssClass="chosen-select" headerKey=""
											headerValue="Select" list="#respData.BILLERCATE"
											name="BillerCategory" id="BillerCategory" requiredLabel="true"
											theme="simple" data-placeholder="Choose Product Currency..." />
											</td>
								</tr>
								<tr>
								<td id="tokenlimit3" ><strong>Super Agent</strong><font color="red">*</font></td>
									<td id="tokenlimit4" >
									<select name="agent" id="agent" Class="chosen-select">
													<option value="">Select</option>
													<option value="XPRESS">XPRESS</option>
													<option value="XPRESS SUPER AGENT">XPRESS SUPER AGENT</option>
