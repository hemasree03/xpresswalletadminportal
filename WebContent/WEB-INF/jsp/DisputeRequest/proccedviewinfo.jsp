...
$(document).ready(function() {
	...
	$('#btn-submit').live('click', function () {
		...
		var url="${pageContext.request.contextPath}/<%=appName %>/proccedconfirmScree.action"; 
		$("#form1")[0].action=url;
		$("#form1").submit();
      ...
      <div id="content" class="span10"> 
	    <div> 
			<ul class="breadcrumb">
			 ...
			 <li><a href="clusterCreation.action">Proceed View</a> <span
						class="divider"> &gt;&gt; </span></li>
			<li><a href="clusterCreation.action">Proceed View Details</a> </li>
 			</ul>
		</div>  
	 	<table height="3">
				 <tr>
	...
	<div class="row-fluid sortable">
		<div class="box span12">
			<div class="box-header well" >
					<i class="icon-edit"></i>Proceed View Details
