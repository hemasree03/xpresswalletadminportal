...
$(function () { 
	 ...
	 $('#btn-submit').live('click', function () { 
		 $("#form1").validate(createfeeRules);
			...
			var total=parseFloat($('#agent').val());
					 ...
					 <fieldset>   
						<table width="950" border="0" cellpadding="5" cellspacing="1"  class="table table-striped table-bordered bootstrap-datatable ">
							...
							<td width="20%"><label for="Bank">
								...
								<span id="bin_err1" class="errmsg"></span></td>
								<td width="20%"><label for="Bank">
								<strong>Super Agent<font color="red">*</font></strong></label> 
								</td>
								<td width="30%">
								<input name="SuperAgent" id="SuperAgent"  type="text" maxlength ='25'  required="true"  value="<s:property value='#respData.Feecodedetails.SUPERAGENT' />" class="field"   /><span id="bin_err1" class="errmsg"></span>
