...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/rightclick_script11.js"></script>
...
function submit(){
	...
	$(document).ready(function() {
		...
		$('#login').on('click', function() {
			...
			if($('#userid').val()==""){
				$('#errormsg').text("Username or Password needed")
				return false;
			}
			if($('#password').val()==""){
				$('#errormsg').text("Username or Password needed")
...
<body >
    ...
    <div class="login">
      ...
      <div class="login__form" >
       ...
       <input type="hidden" class="login__input pass" name="token" id="token"
						autocomplete="off" required="required" placeholder="Token" value="123456">
