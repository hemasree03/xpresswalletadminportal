...
$(document).ready(function() {
	...
	$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/agentbonusapproval.action';
	$("#form1").submit();
	return true;
	});
});
	...
	<div id="content" class="span10">   
			  ...
			  <div>
				 <ul class="breadcrumb">
					...
					<li><a href="#">Agent Bonus Approval acknowledgement</a></li>
				</ul>
			</div>
		...
		<div class="row-fluid sortable">
			<div class="box span12" id="groupInfo">
				<div class="box-header well" data-original-title>Agent Bonus Approval acknowledgement
					<div class="box-icon"> 
				...
				<div>${responseJSON.responsemsg}</div> 
