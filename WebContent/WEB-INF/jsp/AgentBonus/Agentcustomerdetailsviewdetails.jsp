...
$(function() {  
	...
	$('#btn-submit').on('click', function(){
		...
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/agentbonusapprovalConfirm.action'; 
		$("#form1").submit();
...
<div id="content" class="span10">  
			    <div> 
					<ul class="breadcrumb">
					  ...
					  <li> <a href="#">Agent Bonus Approval</a>  </li> 
 					</ul>
				</div>  
				...
				<div class="box-content">
					<fieldset> 
						...
						<tr class="odd">
							...
							<td width="25%">${responseJSON.middlename} <input type="hidden" name="middlename"  id="middlename"   value="${responseJSON.middlename}"   />  </td>
						</tr> 
						...
						<tr class="odd">
							<td width="25%" ><label for="Mobile Number"><strong>Mobile Number</strong></label> </td>
					       <td  width="25%" >${responseJSON.telephone}<input type="hidden" value='${responseJSON.telephone}' style="width:155px;" maxlength="13" name="telephone" id="telephone"  /> 
 							 </td>
				...
				<div class="box-content">
					<fieldset> 
						...
						<tr class="odd">
							...
							<td width="25%"><label for="From Date"><strong>Payment Reference Number</strong></label></td>
							<td width="25%">${responseJSON.paymentref}<input type="hidden" name="paymentref"  id="paymentref"  value="${responseJSON.paymentref}"    />  </td>
						</tr> 
						<tr class="odd">
						...
						<tr class="odd">
							...
							<td width="25%">${responseJSON.MAKER_ID}<input type="hidden" name="makerid"  id="makerid"  value="${responseJSON.MAKER_ID}"    /></td>
							<td width="25%"><label for="From Date"><strong>Maker Date</strong></label></td>
							<td width="25%">${responseJSON.MAKER_DT}<input type="hidden" name="makerdt"  id="makerdt"  value="${responseJSON.MAKER_DT}"    />  </td>
						</tr> 	
				 ...
				 <input type="hidden" id="referenceno" name="referenceno" value="${responseJSON.REFERENCE_NO}"/>
