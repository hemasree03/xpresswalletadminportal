...
function addrow()
{
		...
		if($("#form1").valid()) { 
			...
			var queryString = "entity=${loginEntity}&method=validatemcc&transaction="+finalobj.adminType;
	...
	$.getJSON("postJson.action", queryString,function(data) { 
		...
		if(data.finalCount==0){	
				if(status){
						...
						$("#errormsg").html("<font colour='red'>Already Exists</font>");
...
{   
		...
		$("#form2")[0].action='<%=request.getContextPath()%>/<%=appName %>/mccCreationconfirm.action';
		$("#form2").submit();
		return true; 
	...
	<div id="content" class="span10">  
			<div>
				<ul class="breadcrumb">
				  ...
				  <li><a href="#">Merchant Category Code Creation</a></li>
				</ul>
			</div>
		...
		<div class="row-fluid sortable"><!--/span--> 
			<div class="box span12">  
					...
					<div id="primaryDetails" class="box-content">
							...
							<div class="box span12"> 
					<div class="box-header well" data-original-title>Merchant Category Code Creation 
					  <div class="box-icon"> 
			...
			<fieldset>
						...
						<table width="950" border="0" cellpadding="5" cellspacing="1" 
							   class="table table-striped table-bordered bootstrap-datatable " id="bank-details">
													...
													<tr class="odd">
														<td width="20%"><label for="Channel"><strong>Category Code<font color="red">*</font></strong></label></td>
														<td width="30%">
														<input name="adminType" id="adminType"  type="text"  class="field" />
														</td>											
														<td width="20%"><label for="Services"><strong>Category Name <font color="red">*</font></strong></label></td>
