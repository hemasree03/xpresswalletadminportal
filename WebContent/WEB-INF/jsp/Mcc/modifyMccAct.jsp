...
$(document).ready(function(){   
 	...
 	//alert(message);
 	    ...
 	    var finalData = "";
			...
			if ($("#form1").valid()==true)
				{
					 $("#form1")[0].action="<%=request.getContextPath()%>/<%=appName %>/modifyMccconfirm.action";
					 $("#form1").submit();
				} 
	}); 
...
<form name="form1" id="form1" method="post" >
	...
	<div class="row-fluid sortable">
		...
		<div class="box-content">
								...
								<tr class="even">
								<td width="20%"><label for="Limit Code"><strong>Category Code</strong></label></td>
								<td width="30%"><s:property value='#respData.limitcodedetails.limitCode' />
								
								<input name="categoryCode" id="categoryCode"  type="hidden" class="field" required=true maxlength="150" value="<s:property value='#respData.limitcodedetails.limitCode'/>" /></td>
								 <td width="20%"><label for="Limit Description"><strong>Category Name<font color="red">*</font></strong></label></td>
								 <td width="30%"><input name="categoryName" id="categoryName"  type="text" class="field" required=true maxlength="150" value="<s:property value='#respData.limitcodedetails.limitDesc'/>" /> </td>
							</tr>
