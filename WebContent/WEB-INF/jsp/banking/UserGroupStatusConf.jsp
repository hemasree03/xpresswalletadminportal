...
$(document).ready(function(){
	...
	$('#btn-submit').live('click',function() {  
		checkLink();		  
		$("#form1")[0].action="<%=request.getContextPath()%>/<%=appName %>/StatusGroupDetailsAck.action";
		$("#form1").submit();				
	});
		...
		<div> 
			<ul class="breadcrumb">
			  ...
			  <li> <a href="userGrpCreation.action">User Management</a> <span class="divider"> &gt;&gt; </span></li>
			   <li> <a href="#" id="mod-grp">Status Group</a> <span class="divider"> &gt;&gt; </span></li>
			  <li><a href="#">Status Group Confirmation </a></li>
			</ul>
		</div>  
		<div class="row-fluid sortable"> 
			<div class="box span12"> 
				<div class="box-header well" data-original-title>
						<i class="icon-edit"></i>Status Group Confirmation 
					<div class="box-icon">
