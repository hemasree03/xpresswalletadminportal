...
$('#regester-CampaignEmail').click(function(){
	 $("#rege").val('R');
	 $("#form")[0].action='<%=request.getContextPath()%>/<%=appName %>/createcampaignmgntact.action'; 
		$('#form').submit();
		 return true; 
...
$('#assign-Campaign').click(function(){
	...
	var status = "";
			...
			else if (v_id ==  "regester-CampaignEmail") v_action="createcampaignmgntactemail";
		...
		<div id="content" class="span10">  
      		...
      		<div class="box-content" id="top-layer-anchor"> 
				 <div>
					...
					<a href="#" class="btn btn-success" id="regester-CampaignEmail">Send Campaign mail</a> &nbsp;&nbsp;
