...
$(function() {
	...
	if(auth_code == 'USERAUTH') {
 	...
 	else if(auth_code == 'AGNTMOBUPDATEAUTH') {
		$('.merchant').text('Agent Mobile Channel Status Update');
 	}
 	else if(auth_code == 'AGNTUSDSTATUSAUTH') {
		$('.merchant').text('Agent Ussd Channel Status Update');
 	}
 	else if(auth_code == 'AGNTPOSSTATUSAUTH') {
		$('.merchant').text('Agent POS Channel Status Update');
 	}
 	else if(auth_code == 'AGNTPRDUPDATE') {
		$('.merchant').text('Agent Wallet Customer Product Update');
 	}
 	else if(auth_code == 'LNKACCOUNT') {
		$('.merchant').text('Agent Link Account');
 	}
		...
		$('.merchant').text('Super Agent Status Update');
 	}else if(auth_code == 'SUPERAGENTMODIFYAUTH') {
		$('.merchant').text('Super Agent Modify');
 	}else if(auth_code == 'INITIALPRD') {
		$('.merchant').text('Initial Product Authrisation');
 	}else if(auth_code == 'ADDNEWGRP') {
		$('.merchant').text('New Group Creation');
 	}else if(auth_code == 'MODGRP') {
		$('.merchant').text('Modify Group ');
 	} else if(auth_code == 'ACTDCTGRP') {
		$('.merchant').text('Active/Deactive Group ');
 	}else if(auth_code == 'PRDNEWAUTH') {
		$('.merchant').text('New Product Authrisation');
 	}else if(auth_code == 'PRDMODAUTH') {
		$('.merchant').text('Product Modify Authrisation');
 	}else if(auth_code == 'PRDACTAUTH') {
		$('.merchant').text('Product Status Update Authrisation');
 	}else if(auth_code == 'LMTNEWAUTH') {
		$('.merchant').text('New Limit Authrisation');
 	}else if(auth_code == 'LMTMODAUTH') {
		$('.merchant').text('Modify Limit Authrisation');
 	}else if(auth_code == 'FEENEWAUTH') {
		$('.merchant').text('New Fee Authrisation');
 	}else if(auth_code == 'FEEMODAUTH') {
		$('.merchant').text('Modify Fee Authrisation');
 	}else if(auth_code == 'FEEACTAUTH') {
		$('.merchant').text('Status Fee Authrisation');
 	}else if(auth_code == 'CATCREAUTH') {
		$('.merchant').text('Category Creation Authrisation');
 	}else if(auth_code == 'CATMODIFYAUTH') {
		$('.merchant').text('Category Modify Authrisation');
 	}else if(auth_code == 'CATSTATUSAUTH') {
		$('.merchant').text('Category Status Change Authrisation');
 	}else if(auth_code == 'BILLERCATCREAUTH') {
		$('.merchant').text('BillerCategory Group Creation Authrisation');
 	}else if(auth_code == 'BILLERCATMODIFYAUTH') {
		$('.merchant').text('BillerCategory Group Modify Authrisation');
 	}else if(auth_code == 'BILLERCATSTATUSAUTH') {
		$('.merchant').text('BillerCategory Group Status Change Authrisation');
 	}else if(auth_code == 'SUBCATCREAUTH') {
		$('.merchant').text('Sub Category Creation Authrisation');
 	}else if(auth_code == 'BILLERFEECREAUTH') {
		$('.merchant').text('Bille Fee Creation Authrisation');
 	}else if(auth_code == 'CASHOUTLNK') {
		$('.merchant').text('Cashout Account Link');
 	}else if(auth_code == 'CASHOUTMODLNK') {
		$('.merchant').text('Cashout Account Modify');
 	}
									...
									<s:iterator value="#respData.agentMultiData" var="authCommonList" status="authCommonStatus">  
										<s:if test="#authCommonStatus.even == true" > 
										 ...
										 <s:elseif test="#authCommonStatus.odd == true">
		   								 ...
		   								 <s:elseif test="#respData.auth_code == 'AGNTMOBUPDATEAUTH' " >		   								 	
 											<td><s:property value="#authCommonList['CUSTCODE']" /> </td>   
 											<td><s:property value="#authCommonList['NAME']" /> </td> 
 											<td><s:property value="#authCommonList['NATIONALID']" /> </td>  
 											<td><s:property value="#authCommonList['MOBILENUMBER']" /> </td>    
		   								 ...
		   								 <s:elseif test="#respData.auth_code == 'AGNTUSDSTATUSAUTH' " >		   								 	
 											<td><s:property value="#authCommonList['CUSTCODE']" /> </td>   
 											<td><s:property value="#authCommonList['NAME']" /> </td> 
 											<td><s:property value="#authCommonList['NATIONALID']" /> </td>  
 											<td><s:property value="#authCommonList['MOBILENUMBER']" /> </td>    
		   								 ...
		   								 <s:elseif test="#respData.auth_code == 'AGNTPOSSTATUSAUTH' " >		   								 	
 											<td><s:property value="#authCommonList['CUSTCODE']" /> </td>   
 											<td><s:property value="#authCommonList['NAME']" /> </td> 
 											<td><s:property value="#authCommonList['NATIONALID']" /> </td>  
 											<td><s:property value="#authCommonList['MOBILENUMBER']" /> </td>    
		   								 ...
		   								 <s:elseif test="#respData.auth_code == 'LNKACCOUNT' " >		   								 	
 											<td><s:property value="#authCommonList['CUSTCODE']" /> </td>   
 											<td><s:property value="#authCommonList['NAME']" /> </td> 
 											<td><s:property value="#authCommonList['NATIONALID']" /> </td>  
 											<td><s:property value="#authCommonList['MOBILENUMBER']" /> </td>    
										...
										<s:elseif test="#respData.auth_code == 'WDELACCAUTH' " >	
										 ...
										 <s:elseif test="#respData.auth_code == 'PRODUCTCREAUTH' " >	
		 								 ...
		 								 <s:elseif test="#respData.auth_code == 'STOREAUTH' " >		   								 	
											...
											<td class='hidden-phone'><a href='#' class='label label-info' index='#authCommonStatus.index'><s:property value="#authCommonList['STATUS']" /></a> </td>
		   								  ...
		   								  <s:elseif test="#respData.auth_code == 'SUPERAGENTMODIFYAUTH' " >
											<td><s:property value="#authCommonList['ACCOUNTNUMBER']" /> </td>
											<td><s:property value="#authCommonList['ACCOUNTNAME']" /> </td>
											<td><s:property value="#authCommonList['MANAGERNAME']" /> </td>
											<td><s:property value="#authCommonList['MAKER_ID']" /> </td>
		   								 ...
		   								 <s:elseif test="#respData.auth_code == 'INITIALPRD' " >
											<td><s:property value="#authCommonList['PRODUCT_CODE']" /> </td>
											<td><s:property value="#authCommonList['PRODUCT_NAME']" /> </td>
											<td><s:property value="#authCommonList['MAKER_ID']" /> </td>
											<td><s:property value="#authCommonList['MAKER_DTTM']" /> </td>
		   								 </s:elseif>
		   								 
		   								 <s:elseif test="#respData.auth_code == 'ADDNEWGRP' " >		   								 	
 											<td><s:property value="#authCommonList['group_id']" /> </td>   
 											<td><s:property value="#authCommonList['MAKER_ID']" /> </td>    
 											<td><s:property value="#authCommonList['MAKER_DATE']" /> </td> 
 											<td class='hidden-phone'><a href='#' class='label label-info' index='#authCommonStatus.index'><s:property value="#authCommonList['STATUS']" /></a> </td> 
		   								 </s:elseif>  
		   								 
		   								 <s:elseif test="#respData.auth_code == 'MODGRP' " >		   								 	
 											<td><s:property value="#authCommonList['group_id']" /> </td>   
 											<td><s:property value="#authCommonList['MAKER_ID']" /> </td>    
 											<td><s:property value="#authCommonList['MAKER_DATE']" /> </td> 
 											<td class='hidden-phone'><a href='#' class='label label-info' index='#authCommonStatus.index'><s:property value="#authCommonList['STATUS']" /></a> </td> 
		   								  ...
		   								  <s:elseif test="#respData.auth_code == 'ACTDCTGRP' " >		   								 	
 											<td><s:property value="#authCommonList['group_id']" /> </td>   
 											<td><s:property value="#authCommonList['MAKER_ID']" /> </td>    
 											<td><s:property value="#authCommonList['MAKER_DATE']" /> </td> 
 											<td class='hidden-phone'><a href='#' class='label label-info' index='#authCommonStatus.index'><s:property value="#authCommonList['STATUS']" /></a> </td> 
		   								 ...
		   								 <s:elseif test="#respData.auth_code == 'PRDNEWAUTH' " >
											<td><s:property value="#authCommonList['PRODUCT_CODE']" /> </td>
											<td><s:property value="#authCommonList['PRODUCT_NAME']" /> </td>
											<td><s:property value="#authCommonList['MAKER_ID']" /> </td>
											<td><s:property value="#authCommonList['MAKER_DTTM']" /> </td>
		   								 ...
		   								 <s:elseif test="#respData.auth_code == 'PRDMODAUTH' " >
											<td><s:property value="#authCommonList['PRODUCT_CODE']" /> </td>
											<td><s:property value="#authCommonList['PRODUCT_NAME']" /> </td>
											<td><s:property value="#authCommonList['MAKER_ID']" /> </td>
											<td><s:property value="#authCommonList['MAKER_DTTM']" /> </td>
		   								 ...
		   								 <s:elseif test="#respData.auth_code == 'PRDACTAUTH' " >
											<td><s:property value="#authCommonList['PRODUCT_CODE']" /> </td>
											<td><s:property value="#authCommonList['PRODUCT_NAME']" /> </td>
											<td><s:property value="#authCommonList['MAKER_ID']" /> </td>
											<td><s:property value="#authCommonList['MAKER_DTTM']" /> </td>
		   								 ...
		   								 <s:elseif test="#respData.auth_code == 'LMTNEWAUTH' " >
											<td><s:property value="#authCommonList['PRODUCT']" /> </td>
											<td><s:property value="#authCommonList['LMT_FEE_CODE']" /> </td>
											<td><s:property value="#authCommonList['LMT_FEE_DESC']" /> </td>
											<td><s:property value="#authCommonList['MAKER_ID']" /> </td>
											<td><s:property value="#authCommonList['MAKER_DTTM']" /> </td>
		   								 </s:elseif>
		   								 
		   								 <s:elseif test="#respData.auth_code == 'LMTMODAUTH' " >
											<td><s:property value="#authCommonList['PRODUCT']" /> </td>
											<td><s:property value="#authCommonList['LMT_FEE_CODE']" /> </td>
											<td><s:property value="#authCommonList['LMT_FEE_DESC']" /> </td>
											<td><s:property value="#authCommonList['MAKER_ID']" /> </td>
		   								 ...
		   								 <s:elseif test="#respData.auth_code == 'FEENEWAUTH' " >
											<td><s:property value="#authCommonList['PRODUCT']" /> </td>
											<td><s:property value="#authCommonList['LMT_FEE_CODE']" /> </td>
											<td><s:property value="#authCommonList['LMT_FEE_DESC']" /> </td>
											<td><s:property value="#authCommonList['MAKER_ID']" /> </td>
											...
											<td class='hidden-phone'><a href='#' class='label label-info' index='#authCommonStatus.index'><s:property value="#authCommonList['STATUS']" /></a> </td>
		   								  ...
		   								  <s:elseif test="#respData.auth_code == 'FEEMODAUTH' " >
											<td><s:property value="#authCommonList['PRODUCT']" /> </td>
											<td><s:property value="#authCommonList['LMT_FEE_CODE']" /> </td>
											<td><s:property value="#authCommonList['LMT_FEE_DESC']" /> </td>
											<td><s:property value="#authCommonList['MAKER_ID']" /> </td>
											...
											<td class='hidden-phone'><a href='#' class='label label-info' index='#authCommonStatus.index'><s:property value="#authCommonList['STATUS']" /></a> </td>
		   								  ...
		   								  <s:elseif test="#respData.auth_code == 'FEEACTAUTH' " >
											<td><s:property value="#authCommonList['PRODUCT']" /> </td>
											<td><s:property value="#authCommonList['LMT_FEE_CODE']" /> </td>
											<td><s:property value="#authCommonList['LMT_FEE_DESC']" /> </td>
											<td><s:property value="#authCommonList['MAKER_ID']" /> </td>
		   								 ...
		   								 <s:elseif test="#respData.auth_code == 'CASHOUTLNK' " > 	
										    <td><s:property value="#authCommonList['CUSTCODE']" /> </td>   
										    <td><s:property value="#authCommonList['NAME']" /> </td> 
										    <td><s:property value="#authCommonList['NATIONALID']" /> </td>  
										    <td><s:property value="#authCommonList['MOBILENUMBER']" /> </td>    
										 ...
										 <s:elseif test="#respData.auth_code == 'CASHOUTMODLNK' " > 	
										    <td><s:property value="#authCommonList['CUSTCODE']" /> </td>   
										    <td><s:property value="#authCommonList['NAME']" /> </td> 
										    <td><s:property value="#authCommonList['NATIONALID']" /> </td>  
										    <td><s:property value="#authCommonList['MOBILENUMBER']" /> </td>    
		   								 ...
		   								 <s:elseif test="#respData.auth_code == 'CATCREAUTH' " >
											<td><s:property value="#authCommonList['CAT_ID']" /> </td>
											<td><s:property value="#authCommonList['CAT_NAME']" /> </td>
											<td><s:property value="#authCommonList['MAKER_ID']" /> </td>
											<td><s:property value="#authCommonList['MAKER_DTTM']" /> </td>
		   								 </s:elseif>
		   								 
		   								 <s:elseif test="#respData.auth_code == 'CATMODIFYAUTH' " >
											<td><s:property value="#authCommonList['CAT_ID']" /> </td>
											<td><s:property value="#authCommonList['CAT_NAME']" /> </td>
											<td><s:property value="#authCommonList['MAKER_ID']" /> </td>
											<td><s:property value="#authCommonList['MAKER_DTTM']" /> </td>
		   								 ...
		   								 <s:elseif test="#respData.auth_code == 'CATSTATUSAUTH' " >
											<td><s:property value="#authCommonList['CAT_ID']" /> </td>
											<td><s:property value="#authCommonList['CAT_NAME']" /> </td>
											<td><s:property value="#authCommonList['MAKER_ID']" /> </td>
											<td><s:property value="#authCommonList['MAKER_DTTM']" /> </td>
		   								  ...
		   								  <s:elseif test="#respData.auth_code == 'BILLERCATCREAUTH' " >
											<td><s:property value="#authCommonList['CATGRP_CODE']" /> </td>
											<td><s:property value="#authCommonList['CATGRP_NAME']" /> </td>
											<td><s:property value="#authCommonList['MAKER_ID']" /> </td>
											<td><s:property value="#authCommonList['MAKER_DTTM']" /> </td>
		   								 </s:elseif>
		   								 
		   								 <s:elseif test="#respData.auth_code == 'BILLERCATMODIFYAUTH' " >
											<td><s:property value="#authCommonList['CATGRP_CODE']" /> </td>
											<td><s:property value="#authCommonList['CATGRP_NAME']" /> </td>
											<td><s:property value="#authCommonList['MAKER_ID']" /> </td>
											<td><s:property value="#authCommonList['MAKER_DTTM']" /> </td>
		   								 ...
		   								 <s:elseif test="#respData.auth_code == 'BILLERCATSTATUSAUTH' " >
											<td><s:property value="#authCommonList['CATGRP_CODE']" /> </td>
											<td><s:property value="#authCommonList['CATGRP_NAME']" /> </td>
											<td><s:property value="#authCommonList['MAKER_ID']" /> </td>
											<td><s:property value="#authCommonList['MAKER_DTTM']" /> </td>
		   								 ...
		   								 <s:elseif test="#respData.auth_code == 'SUBCATCREAUTH' " >
											<td><s:property value="#authCommonList['CAT_ID']" /> </td>
											<td><s:property value="#authCommonList['CAT_NAME']" /> </td>
											<td><s:property value="#authCommonList['MAKER_ID']" /> </td>
											<td><s:property value="#authCommonList['MAKER_DTTM']" /> </td>
		   								 ...
		   								 <s:elseif test="#respData.auth_code == 'BILLERFEECREAUTH' " >
											<td><s:property value="#authCommonList['CAT_ID']" /> </td>
											<td><s:property value="#authCommonList['MAKER_ID']" /> </td>
											<td><s:property value="#authCommonList['MAKER_DTTM']" /> </td>
		   								 </s:elseif>
