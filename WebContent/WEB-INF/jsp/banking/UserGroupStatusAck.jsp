		...
		<div id="content" class="span10"> 
			...
			<div> 
				<ul class="breadcrumb">
				  ...
				  <li><a href="#">Status Group Acknowledgement </a></li>
				</ul>
			</div>  
		<div class="row-fluid sortable"> 
			<div class="box span12"> 
				<div class="box-header well" data-original-title>
						<i class="icon-edit"></i>Status Group Acknowledgement
					<div class="box-icon">
					 ...
					 <fieldset> 
							<table width="950" border="0" cellpadding="5" cellspacing="1" 
								class="table table-striped table-bordered bootstrap-datatable "> 
								 <tr>
									<td></td>
									<td >'${groupID }' Group Status Successfully Changed, Pending for Authorization. </td>
									<td ></td>	
								</tr>
						</table>  
					</fieldset>   
