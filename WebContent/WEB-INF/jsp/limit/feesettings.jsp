...
var feehederdata="channel|selecttext#operators|selecttext#FeeTransaction|selecttext#FeeTransaction|selectvalue#FeeFrequency|selectvalue#FeeFrequency|selecttext#FlatPercentile|selecttext#FlatPercentile|selectvalue#FPValue|text#Criteria|selecttext#Criteria|selectvalue#FromValue|text#ToValue|text#Agent|text#Ceva|text#Bank|text#SuperAgent|text#VAT|text#thirdparty|text";
var feejsonObj = [];
...
$(function() {	
	 ...
	 $('#Product').on('change', function (e) {
	    	...
	    	$('#superagn').text(valueSelected.split("-")[4]);
	 ...
	 $('#channel').on('change', function (e) {
		...
		$('#btn-fee-add').live('click', function () {
			...
			var total=parseFloat(finalobj.Agent);
						...
						<fieldset>
							<table width="950" border="0" cellpadding="5" cellspacing="1"
								...
								<tr class="even">
									...
									<td><label for="Product Currency"><strong>Super Agent</strong></label></td>
									<td><div id="superagn"></div>
									</td>
									<td></td>
									<td></div>
									</td>
					 ...
					 <fieldset>   
						<table width="950" border="0" cellpadding="5" cellspacing="1"  class="table table-striped table-bordered bootstrap-datatable ">
							...
							<%-- <tr class="even">
								...
								<td width="30%">
								<input type="radio" name="feecharge" id="Customer"/>&nbsp;<strong>Customer</strong>&nbsp;&nbsp;&nbsp;
								<input type="radio" name="feecharge" id="Agent"/>&nbsp;<strong>Agent</strong>
								</td>
