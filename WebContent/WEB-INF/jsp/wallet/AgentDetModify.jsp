...
<script type="text/javascript"
	src='${pageContext.request.contextPath}/js/bootstrap-2.3.2.min.js'></script>
...
$(document).ready(function(){
	...
	$('#btn-submit').click(function(){ 
			...
			if($("#form1").valid()) { 
				myApp.showPleaseWait();
 				$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/agentupdatesearch.action'; 
				$('#form1').submit();
				 return true; 
			} else { 
				return false;
	...
	<form name="form1" id="form1" method="post" action="">
		<div id="content" class="span10">
			...
			<div class="row-fluid sortable">
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<i class="icon-edit"></i>Search Agent Details
						<div class="box-icon">
					...
					<div class="box-content" id="primaryDetails">
						<fieldset>
							<table width="950" border="0" cellpadding="5" cellspacing="1"
								...
								<tr class="even">
									<td width="20%"><label for="Service ID"><strong>Select
												Search Criteria<font color="red">*</font>
										</strong></label></td>
									<td width="30%" colspan=3><s:select
											cssClass="chosen-select" headerKey="" headerValue="Select"
											list="#{'MOBILE_NUMBER':'Mobile Number','ACCT_NO':'Account Number'}"
											name="srchcriteria" id="srchcriteria" requiredLabel="true"
											theme="simple" data-placeholder="Choose Account Type..." />
										</label></td>
								</tr>
								<tr class="odd" id="trow1" name="trow1" style="display: none">
									<td><label><strong><span id="rettext"
												name="rettext"></span><font color="red">*</font></strong></label></td>
									<td><input type="text" name="isocode" id="isocode"
										style="display: none; width: 25px;" value="234" disabled><input
										type="text" name="customerId" id="customerId" required=true
										value="<s:property value='customerId' />" /> <input
										type="hidden" id="customercode" name="customercode"> <input
										type="hidden" name="makerid" id="makerid"
										value="<%=(String)session.getAttribute(CevaCommonConstants.MAKER_ID) %>" />
									</td>
									<td><a class="btn btn-success" href="#" id="btn-srch"
										name="btn-submit">Search</a></td>
								</tr>
				...
				<div class="box span12">
					...
					<div class="box-content">
						<table
							...
							id="ex-mytable" style="width: 100%; display: none">
							<thead>
								<tr>
									<!-- <th>Sno</th> -->
									<th>Customer ID</th>
			...
			<div class="form-actions">
				...
				<a class="btn btn-success" href="#" id="btn-submit"
					name="btn-submit" style="display: none">Proceed</a> <span
					id="billerMsg" class="errors"></span>
			</div>
		</div>
	</form>
	<script type="text/javascript">
