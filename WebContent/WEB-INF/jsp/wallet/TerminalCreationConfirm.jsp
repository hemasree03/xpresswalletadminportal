					...
					<div class="box-content" id="terminalDetails">
						<fieldset>
							<table width="950" border="0" cellpadding="5" cellspacing="1"
								...
								<tr class="even">
									<td width="25%"><label for="Product Code"><strong>Super Agent</strong></label></td>
									<td width="25%">${responseJSON.superagentcode}
										  <input  type="hidden"   name="superagentcode" id="superagentcode"  value="${responseJSON.superagentcode}" />
									</td>
									<td width="25%"><label for="Product Description"><strong>Super Agent Id</strong></label></td>
									<td width="25%">${responseJSON.superagentid}
										  <input  type="hidden"   name="superagentid" id="superagentid"  value="${responseJSON.superagentid}" />
