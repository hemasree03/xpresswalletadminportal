	...
	<div class="box span12"> 
				...
				<div class="box-content">
					<fieldset> 
						...
						<tr class="even">
							...
							<td width="25%"><s:property value='#respData.custcode' /><input type="hidden" name="custcode"  id="custcode"   value="<s:property value='#respData.custcode' />"   />
							<td width="25%"><label for="To Date"><strong>Customer Name</strong></label><input type="hidden" name="institute"  id="institute"   value="<s:property value='#respData.institute' />"   /> </td>
							<td width="25%"><s:property value='#respData.fullname' /> <input type="hidden" name="fullname"  id="fullname"   value="<s:property value='#respData.fullname' />"   />  </td>
						</tr>  
						<tr class="even">
				 ...
				 <tr class="odd">
						...
						<tr class="even">
							...
							<td width="25%"><s:property value='#respData.prodesc' /></td>
						</tr> 
						<tr class="even">
							<td width="25%"><label for="Product"><strong>Status</strong></label></td>
							<td width="25%"><s:property value='#respData.status' /></td>
						    <td  width="25%"><label for="Marital Status"><strong>Marital Status</strong></label></td>
							 <td  width="25%">${responseJSON.martStatus} <input type="hidden" name="martStatus"  id="martStatus"   value="${responseJSON.martStatus}"   />  </td>
						
						</tr>
						 <tr class="even">
										<td  width="25%"><label for="bvn"><strong>BVN</strong></label></td>
										<td  width="25%">${responseJSON.bvn} <input type="hidden" name="bvn"  id="bvn"   value="${responseJSON.bvn}"  />  </td>
							<td  width="25%"><label for="bvn"><strong>Staff Code</strong></label></td>
										<td  width="25%">${responseJSON.staffcode} <input type="hidden" name="staffcode"  id="staffcode"   value="${responseJSON.staffcode}"  />  </td>
								</tr>  
				 </table>
				</fieldset> 
				</div>  
	 ...
	 <div class="row-fluid sortable">
					...
					<%-- 	<td width="25%">${responseJSON.idtype}<input type="hidden" name="idtype"  id="idtype" value="${responseJSON.idtype}"   /></td>
					 --%>	
					 <td width="25%"><s:property value='#respData.idtype' /></td>
