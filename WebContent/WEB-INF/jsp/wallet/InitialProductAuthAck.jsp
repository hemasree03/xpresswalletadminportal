			...
			<div class="box-header well" data-original-title>
				...
				<div class="box-content">
					<fieldset> 
						...
						<tr class="even">
							<td width="20%"><label for="From Date"><strong>Product Code</strong></label></td>
							<td width="30%"><s:property value='#respData.PRODUCT_CODE' /><input type="hidden" name="productcode"  id="productcode"   value="<s:property value='#respData.PRODUCT_CODE' />"   />
							<td width="20%"><label for="To Date"><strong>Product Description</strong></label><input type="hidden" name="institute"  id="institute"   value="<s:property value='#respData.institute' />"   /> </td>
							<td width="30%"><s:property value='#respData.PRODUCT_NAME' /> <input type="hidden" name="productname"  id="productname"   value="<s:property value='#respData.PRODUCT_NAME' />"   />  </td>
						</tr>  
