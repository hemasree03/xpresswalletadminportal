 ...
 */				if(jsonObject.STATUS=="P"){
					htmlString = htmlString + "&nbsp&nbsp<a class='btn btn-warning' href='#' id='terminalactive' index="+i+" val="+i+" title='Retrive Terminal' data-rel='tooltip' > <i class='icon icon-remove icon-white'></i></a></td>";
				}
	...
	<div id="content" class="span10">   
           ...
           <div class="row-fluid sortable"><!--/span-->
			...
			<div class="box span12" id="groupInfo">
				<div class="box-header well" data-original-title>Super Agent Terminal Information
					<div class="box-icon"> 
				...
				<div class="box-content"> 
					...
					<div>
								<a href="#" id="btn-back" class="btn btn-danger ajax-link">Back
								</a> <span
