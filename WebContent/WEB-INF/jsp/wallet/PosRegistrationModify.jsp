...
$(function() {  
	...
	$('#btn-submit').on('click', function(){
		...
		if($('#ismerchant').val()=="YES"){
			if($('#merchantid').val()==""){
				$('#errors').text("Please Enter NIBBS TID");
				return true;
			}
		}
						...
						<div class="box span12">
								...
								<div id="communicationDetails" class="box-content">
									<fieldset>
										...
										<tr class="odd">
										   <td width="25%"><label for="IDNumber"><strong>Merchant<font color="red">*</font></strong></label>	</td>
												<td width="25%">
												<input type="checkbox" id="ismer" name="ismer"/>
												<input  type="hidden"   name="ismerchant" id="ismerchant"  value="${responseJSON.ismerchant}" />
												</td>
										   <td></td>
										    <td></td>
									...
									<tr class="odd" id="nibtid" style="display:none">
										   ...
										   <td ><label for="Address Line 1"><strong>NIBBS TID<font color="red">*</font></strong></label></td>
												<td ><input  type="text"   name="merchantid" id="merchantid" class="field" value="${responseJSON.merchantid}" /></td>
