	...
	<form name="form1" id="form1" method="post" autocomplete="off">
			...
			<div id="content" class="span10">  
				...
				<ul class="breadcrumb">
				 ...
				 <li> <a href="AuthorizationAll.action">Super Agent Terminal Authorization</a> <span class="divider"> &gt;&gt; </span></li>
  ...
  <div class="row-fluid sortable"> 
	<div class="box span12"> 
			<div class="box-header well" data-original-title>
					<i class="icon-edit"></i>Super Agent Terminal Details
				<div class="box-icon">
				...
				<div class="box-content">
					<fieldset> 
						...
						<tr class="even">
							<td width="20%"><label for="From Date"><strong>Super Agent</strong></label></td>
							<td width="30%"><s:property value='#respData.SUPERAGENT_NAME' /><input type="hidden" name="superagent"  id="superagent"   value="<s:property value='#respData.SUPERAGENT_NAME' />"   />
							<td width="20%"><label for="To Date"><strong>Super Agent Id</strong></label></td>
							<td width="30%"><s:property value='#respData.AGENTID' /> <input type="hidden" name="agentid"  id="agentid"   value="<s:property value='#respData.AGENTID' />"   />  </td>
						</tr>  
						<tr class="even">
