					...
					<fieldset> 
						 <table width="950" border="0" cellpadding="5" cellspacing="1" 
								...
								<td width="30%"><s:property value='#respData.product' /></td>
								 ...
								 <td width="30%"><s:property value='#respData.application' /> </td>
							</tr>
							<tr class="even">
								<td width="20%"><label for="Limit Code"><strong>Fee Code</strong></label></td>
								<td width="30%"><s:property value='#respData.limitCode' /></td>
								 <td width="20%"><label for="Limit Description"><strong>Fee Description</strong></label></td>
								 <td width="30%"><s:property value='#respData.limitDesc' /> </td>
							</tr>
