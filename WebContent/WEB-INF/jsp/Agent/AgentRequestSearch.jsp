...
$(function () { 
	...
	$('#application').on('change', function (e) {
		...
		$('#mnumber').val("");
			...
			if(this.value =='PAYMENT_REF')
    		{		
    				$("#searchenter").show();
    				$("#rettext").text('Enter Payment Reference Number');
    		...
    		{		
    				$("#searchenter").show();
    				$("#rettext").text('Enter Wallet Reference Number');
	...
	$('#btn-submit').live('click', function () { 
		...
		var queryString = "entity=${loginEntity}&method=validaterefsucrev&fname="+$('#application').val()+"#"+$('#mnumber').val();
							...
							<table width="950"  border="0" cellpadding="5" cellspacing="1" 
								...
								<td width="25%"><label for="Application"><strong>Select Option<font color="red">*</font>
									...
									<td width="25%"><s:select cssClass="chosen-select" 
							         headerKey="" 
							         headerValue="Select"
							         list="#{'PAYMENT_REF':'Payment Reference Number','WALLET_REF':'Wallet Reference Number'}" 
							         name="application" 
							         id="application"
							         requiredLabel="true" 
							         theme="simple"
