					...
					<div class="box-content" id="secondaryDetails">
						<fieldset>
							...
							<tr class="odd" id="searchenter" >
									<td >Discard </td>
									<td ><div class='label label-success' onclick=funcall("DISCARD_COMPLETED") style="cursor: pointer;">${responseJSON.VIEW_LMT_DATA.FUNDING_COMPLETED}</div></td>
									<td><div class='label label-important' onclick=funcall("DISCARD_REJECTED") style="cursor: pointer;">${responseJSON.VIEW_LMT_DATA.FUNDING_REJECTED}</div></td>
