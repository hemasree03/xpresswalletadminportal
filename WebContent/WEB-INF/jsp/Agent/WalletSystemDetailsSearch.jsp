...
var verror="";	
			...
			$('#application').on('change', function (e) {
				...
				$('#fname').val("");
		    		...
		    		if(this.value =='BALANCE_SHEET' || this.value =='EOD_REPORT')
		    		{		$("#searchenter").hide();
		    				$("#datewise").show();
		    				verror="Enter Date";
		    				if(this.value =='EOD_REPORT'){
		    					$("#btn-submit").val("Download");
		    				}
			...
			$('#btn-submit').live('click', function () { 
				...
				if($('#application').val()=="EOD_REPORT"){
					if($('#fromdate').val()==""){
						$('#errormsg').text("Please Enter Date");
						return false;
					}
					var url="${pageContext.request.contextPath}/<%=appName %>/downloadInstantReport.action"; 
					$("#form1")[0].action=url;
					$("#form1").submit();
					return true;
				}
				...
				<div class="box span12">
					...
					<div class="box-content" id="secondaryDetails">
						<fieldset>
							...
							<table width="950"  border="0" cellpadding="5" cellspacing="1" 
								...
								<td width="25%"><label for="Application"><strong>Select Option<font color="red">*</font>
									...
									<td width="25%"><s:select cssClass="chosen-select" 
							         headerKey="" 
							         headerValue="Select"
							         list="#{'WALLET_ACCT_BALANCE':'Wallet Account Balance','BALANCE_SHEET':'Balance Sheet','EOD_REPORT':'EOD Report'}" 
							         name="application" 
							         id="application"
							         requiredLabel="true" 
							         theme="simple"
							...
							<input type="hidden" id="type" name="type" value="eodreport"  /> 
						</fieldset>
