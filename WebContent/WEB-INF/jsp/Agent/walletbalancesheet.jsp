	...
	<div id="content" class="span10">   
		...
		<div class="box span12" id="groupInfo">
			...
			<table width="950"  border="0" cellpadding="5" cellspacing="1" 
								...
								<div class="box span12" id="groupInfo">
				<div class="box-header well" data-original-title>Wallet Commission 
					<div class="box-icon"> 
						<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a> 
						<a href="#" class="btn btn-close btn-round"><i class="icon-remove"></i></a> 
					</div>
			...
			<table width="950"  border="0" cellpadding="5" cellspacing="1" 
								class="table table-striped table-bordered bootstrap-datatable" id="check-kra-details" >
								<tr class="odd" >
									<td width="25%"><label for="fname"><strong>Total Wallet Commission Amount </strong></label></td>
									<td width="25%">${responseJSON.FEE_AMT}</td>
									<td width="25%"></td>
									<td width="25%"></td>
