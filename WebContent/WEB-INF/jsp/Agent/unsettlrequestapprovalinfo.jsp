...
$(document).ready(function() {
	...
	$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/unsettlrequestinfoapprovalack.action';
	$("#form1").submit();
	return true;
	});
});
	...
	<div id="content" class="span10">   
			  ...
			  <div>
				 <ul class="breadcrumb">
					...
					<li><a href="#">Wallet Unsettlement Data  Request Approval Confirmation</a></li>
				</ul>
			</div>
