...
function funcall(v){
	...
	$("#application").val(v);
	var url="${pageContext.request.contextPath}/<%=appName %>/unsettlrequestapprovaldetails.action"; 
	$("#form1")[0].action=url;
	$("#form1").submit();
	return true;
}
						...
						<fieldset>
							...
							<table width="950"  border="0" cellpadding="5" cellspacing="1" 
								...
								<tr class="odd" id="searchenter" >
									...
									<td ><div  class='label label-success' onclick=funcall("COUNT_PENDING") style="cursor: pointer;">${responseJSON.VIEW_LMT_DATA.COUNT_PENDING}</div></td>
									<td><div class='label label-important' onclick=funcall("COUNT_COMPLETED") style="cursor: pointer;">${responseJSON.VIEW_LMT_DATA.COUNT_COMPLETED}</div></td>
